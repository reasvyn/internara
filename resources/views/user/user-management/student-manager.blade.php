<x-ui::components.record-manager :title="__('user.student.title')" :subtitle="__('user.student.subtitle')">
    <x-slot:headerActions>
        <x-ts-button :text="__('user.student.new')" icon="plus" color="primary" sm wire:click="create" />
    </x-slot:headerActions>

    <x-slot:extraMenu>
        <x-ts-dropdown.items :text="__('common.actions.export')" wire:click="export" />
    </x-slot:extraMenu>
