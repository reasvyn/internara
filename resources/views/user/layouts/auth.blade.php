...
<x-core::layouts.base
    :$title
    bodyClass="min-h-screen bg-base-200 flex items-center justify-center py-8"
>
    <div class="w-full max-w-sm px-4">
        <div class="text-center mb-8">
            ...
            >
                <div
                    class="size-14 rounded-xl bg-base-200 flex items-center justify-center transition-transform group-hover:scale-105"
                >
