...
>
    ...
    <x-slot:stats>
        <x-shared::widgets.stat-card icon="o-building-office" :title="__('company.stats.total')" :value="$this->stats['total']" />
        <x-shared::widgets.stat-card icon="o-link" :title="__('company.stats.with_placements')" :value="$this->stats['with_placements']" />
        <x-shared::widgets.stat-card icon="o-hand-raised" :title="__('company.stats.active_partnerships')" :value="$this->stats['active_partnerships']" />
        <x-shared::widgets.stat-card icon="o-briefcase" :title="__('company.stats.available_slots')" :value="$this->stats['available_slots']" />
    </x-slot:stats>
