...
>
    ...
    <x-slot:stats>
        <x-shared::widgets.stat-card icon="o-hand-raised" :title="__('partnership.stats_active')" :value="$this->stats['active']" />
        <x-shared::widgets.stat-card icon="o-clock" :title="__('partnership.stats_expiring_soon', ['days' => 30])" :value="$this->stats['expiring_soon']" />
        <x-shared::widgets.stat-card icon="o-exclamation-circle" :title="__('partnership.stats_expired')" :value="$this->stats['expired']" />
        <x-shared::widgets.stat-card icon="o-document-text" :title="__('partnership.stats_total')" :value="$this->stats['total']" />
    </x-slot:stats>
