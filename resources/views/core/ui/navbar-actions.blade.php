...
>
    ...
    @if ($showTheme)
        <div
            class="hidden md:flex items-center gap-1 bg-base-200/50 p-1 rounded-xl border border-base-content/5"
        >
    ...
    @auth
        ...
        @if ($showUser)
            ...
            <x-mary-dropdown right>
                ...
                <div
                    class="w-56 p-1.5 bg-base-100 border border-base-content/10 rounded-xl shadow-lg"
                >
