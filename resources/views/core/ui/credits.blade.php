...
<div {{ $attributes->merge(['class' => 'flex flex-col items-center gap-6']) }}>
    <div class="flex items-center gap-8 opacity-20 grayscale transition-opacity duration-700 hover:opacity-100 hover:grayscale-0">
    ...
    <div class="flex flex-col items-center gap-2">
        <x-core::ui.app-signature />
        @if ($full)
            <p class="text-[9px] font-black tracking-[0.4em] uppercase opacity-20">
