    ...
    <div class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <x-mary-input
                ...
                type="date"
                wire:model.live="internshipForm.start_date"
            />

            <x-mary-input
                label="{{ __('setup.wizard.end_date') }}"
                type="date"
                wire:model.live="internshipForm.end_date"
            />
        </div>
    </div>
