        ...
        >
            ...
            <div class="bg-base-100 border-base-content/10 relative max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-2xl border shadow-2xl">
                <div class="bg-base-100 border-base-content/10 sticky top-0 flex items-center justify-between rounded-t-2xl border-b px-6 py-4">
                    <h3 id="guide-title" class="text-lg font-bold">{{ __('assessment.guide.rubric_title') }}</h3>
                    <button
                        type="button"
                ...
                <div class="space-y-5 p-6">
                    <p class="text-base-content/60 text-sm">{{ __('assessment.guide.rubric_intro') }}</p>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('assessment.guide.rubric_create_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('assessment.guide.rubric_create_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('assessment.guide.rubric_competency_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('assessment.guide.rubric_competency_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('assessment.guide.rubric_score_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('assessment.guide.rubric_score_desc') }}
                            </p>
                        </div>
                    </div>
                </div>
