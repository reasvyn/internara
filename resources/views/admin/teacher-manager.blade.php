<div class="animate-in fade-in slide-in-from-bottom-8 duration-1000">
    ...
    {{-- Teacher Modal --}}
    <x-mary-modal wire:model="userModal" :title="$form->id ? __('user.teacher.edit') : __('user.teacher.new')" class="backdrop-blur-sm" box-class="rounded-[2.5rem] p-6 border border-base-content/5 shadow-2xl">
        <div class="grid grid-cols-1 gap-6 pt-4">
            ...
            <x-mary-input :label="__('user.teacher.nip')" wire:model="form.nip" icon="o-hashtag" class="rounded-[1.5rem] border-base-content/5 focus:border-primary/30 bg-base-200/50 py-3" />
        </div>
