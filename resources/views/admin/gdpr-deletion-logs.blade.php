<div>
    ...
    <x-shared::ui.page-header :title="__('admin.gdpr_logs.title')" />

    <x-mary-card>
        <div class="flex gap-4 mb-4">
            <x-mary-input wire:model.live.debounce.300ms="search" :placeholder="__('admin.gdpr_logs.search_placeholder')" class="w-72" />
            <x-mary-select wire:model.live="filterType" :placeholder="__('admin.gdpr_logs.type_placeholder')" class="w-48">
