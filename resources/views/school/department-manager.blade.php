...
>
    ...
    <x-slot:stats>
        <x-shared::widgets.stat-card :title="__('department.stats.total')" :value="$stats['total']" icon="o-building-library" color="text-primary" class="lg:col-span-2" />
        <x-shared::widgets.stat-card :title="__('department.stats.with_students')" :value="$stats['with_internships']" icon="o-users" color="text-secondary" class="lg:col-span-2" />
    </x-slot:stats>
