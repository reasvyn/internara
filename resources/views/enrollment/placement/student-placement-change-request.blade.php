<div class="mx-auto mt-6 max-w-2xl">
    ...
    @if (! $registration)
        <x-mary-card>
            <div class="p-6 text-center">
                <x-mary-icon name="o-information-circle" class="text-base-content/40 mx-auto mb-3 h-12 w-12" />
    ...
    @elseif ($pendingRequest)
        <x-mary-card>
            <div class="p-6 text-center">
                <x-mary-icon name="o-clock" class="text-warning mx-auto mb-3 h-12 w-12" />
                ...
                <div class="bg-base-200 mt-3 rounded-lg p-3 text-left text-sm">
                    ...
                    <p class="mt-1">
                        ...
                        <x-mary-badge :value="__('placement_change.status_pending')" class="badge-warning" />
                    </p>
                </div>
            </div>
        </x-mary-card>
    @else
        <x-mary-card>
            ...
            <x-mary-form wire:submit="submit">
                ...
                <x-slot:actions>
                    <x-mary-button
                        :label="__('placement_change.submit')"
                        class="btn-primary"
                        type="submit"
                        spinner="submit"
                    />
