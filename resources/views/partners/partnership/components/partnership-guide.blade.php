<div x-data="{ showGuide: false }">
    <button
        ...
        aria-label="{{ __('partnership.guide.title') }}"
    >
        ...
        <div x-show="showGuide" x-cloak class="fixed inset-0 z-[60] flex items-center justify-center">
            ...
            <div class="relative w-full max-w-lg bg-base-100 rounded-2xl shadow-2xl border border-base-content/10 max-h-[85vh] overflow-y-auto">
                <div class="sticky top-0 bg-base-100 border-b border-base-content/10 px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="text-lg font-bold">{{ __('partnership.guide.title') }}</h3>
                ...
                <div class="p-6 space-y-5">
                    <p class="text-sm text-base-content/60">{{ __('partnership.guide.intro') }}</p>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-sm">{{ __('partnership.guide.create_title') }}</h4>
                            <p class="text-xs text-base-content/60 mt-1 leading-relaxed">{{ __('partnership.guide.create_desc') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-sm">{{ __('partnership.guide.mou_title') }}</h4>
                            <p class="text-xs text-base-content/60 mt-1 leading-relaxed">{{ __('partnership.guide.mou_desc') }}</p>
                        </div>
                    </div>

                    <div class="flex gap-4">
                        <div class="flex items-center justify-center size-8 rounded-full bg-primary/10 text-primary shrink-0 mt-0.5">
                            <x-mary-icon name="o-hand-raised" class="size-4" />
                        </div>
                        <div>
                            <h4 class="font-semibold text-sm">{{ __('partnership.guide.status_title') }}</h4>
                            <p class="text-xs text-base-content/60 mt-1 leading-relaxed">{{ __('partnership.guide.status_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
