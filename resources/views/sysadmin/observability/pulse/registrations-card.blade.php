    ...
    <x-pulse::scroll :expand="$expand">
        <div class="grid grid-cols-2 gap-4 p-4">
            <div class="flex flex-col items-center rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
                ...
                <span class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('sysadmin.pulse.total') }}</span>
            </div>
            <div class="flex flex-col items-center rounded-lg bg-yellow-50 p-4 dark:bg-yellow-900/20">
                ...
                <span class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('sysadmin.pulse.pending') }}</span>
            </div>
            <div class="flex flex-col items-center rounded-lg bg-green-50 p-4 dark:bg-green-900/20">
                ...
                <span class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('sysadmin.pulse.active') }}</span>
            </div>
            <div class="flex flex-col items-center rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
                ...
                <span class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('sysadmin.pulse.completed') }}</span>
            </div>
        </div>
    </x-pulse::scroll>
</x-pulse::card>
