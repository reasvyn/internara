        ...
        <div x-show="showGuide" x-cloak class="fixed inset-0 z-[60] flex items-center justify-center">
            ...
            <div class="relative w-full max-w-lg bg-base-100 rounded-2xl shadow-2xl border border-base-content/10 max-h-[85vh] overflow-y-auto">
                <div class="sticky top-0 bg-base-100 border-b border-base-content/10 px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="text-lg font-bold">{{ __('sysadmin.guide.audit_title') }}</h3>
                ...
                <div class="p-6 space-y-5">
                    <p class="text-sm text-base-content/60">{{ __('sysadmin.guide.audit_intro') }}</p>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-sm">{{ __('sysadmin.guide.audit_filter_title') }}</h4>
                            <p class="text-xs text-base-content/60 mt-1 leading-relaxed">{{ __('sysadmin.guide.audit_filter_desc') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-sm">{{ __('sysadmin.guide.audit_detail_title') }}</h4>
                            <p class="text-xs text-base-content/60 mt-1 leading-relaxed">{{ __('sysadmin.guide.audit_detail_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
