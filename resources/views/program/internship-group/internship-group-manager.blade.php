<x-core::ui.record-manager :title="__('internship.groups')" :subtitle="__('internship.groups_subtitle')">
    <x-slot:headerActions>
        <x-mary-button
            :label="__('internship.create_group')"
            icon="o-plus"
    ...
    <x-slot:modal>
        ...
        <x-mary-modal
            ...
            :title="__('internship.manage_members')"
            separator
            class="backdrop-blur-sm"
        >
            <div class="space-y-4">
                <div class="space-y-3">
                    ...
                    <x-mary-button
                        :label="__('internship.add_member_row')"
                        icon="o-plus"
                        wire:click="addMemberRow"
                        class="btn-ghost btn-sm w-full border border-dashed"
                    />
                </div>
                ...
                <x-slot:actions>
                    ...
                    />
                    <x-mary-button
                        :label="__('internship.add_members')"
