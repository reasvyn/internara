...
>
    ...
    <x-slot:stats>
        <x-core::widgets.stat-card icon="o-calendar" :title="__('internship.stats.total')" :value="$this->stats['total']" />
        <x-core::widgets.stat-card icon="o-play" :title="__('internship.stats.active')" :value="$this->stats['active']" />
        <x-core::widgets.stat-card icon="o-briefcase" :title="__('internship.stats.total_placements')" :value="$this->stats['total_placements']" />
        <x-core::widgets.stat-card icon="o-user-group" :title="__('internship.stats.total_registrations')" :value="$this->stats['total_registrations']" />
    </x-slot:stats>
