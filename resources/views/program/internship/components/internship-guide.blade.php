        ...
        >
            ...
            <div class="bg-base-100 border-base-content/10 relative max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-2xl border shadow-2xl">
                <div class="bg-base-100 border-base-content/10 sticky top-0 flex items-center justify-between rounded-t-2xl border-b px-6 py-4">
                    <h3 id="guide-title" class="text-lg font-bold">{{ __('internship.guide.title') }}</h3>
                    <button
                        type="button"
                ...
                <div class="space-y-5 p-6">
                    <p class="text-base-content/60 text-sm">{{ __('internship.guide.intro') }}</p>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('internship.guide.create_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('internship.guide.create_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <div class="bg-primary/10 text-primary mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-full">
                            <x-ts-icon name="calendar-days" class="size-4" />
                        </div>
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('internship.guide.period_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('internship.guide.period_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        <div class="bg-primary/10 text-primary mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-full">
                            <x-ts-icon name="flag" class="size-4" />
                        </div>
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('internship.guide.status_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('internship.guide.status_desc') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold">{{ __('internship.guide.group_title') }}</h4>
                            <p class="text-base-content/60 mt-1 text-xs leading-relaxed">
                                {{ __('internship.guide.group_desc') }}
                            </p>
                        </div>
                    </div>
                </div>
