<div class="py-4">
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        <x-core::widgets.stat-card :title="__('academic_year.stats_total')" :value="$stats['total']" icon="o-calendar-days" color="text-primary" />
        <x-core::widgets.stat-card :title="__('academic_year.stats_total_internships')" :value="$stats['totalInternships']" icon="o-briefcase" color="text-info" />
        <x-core::widgets.stat-card :title="__('academic_year.stats_with_internships')" :value="$stats['withInternships']" icon="o-building-library" color="text-secondary" />
    </div>
