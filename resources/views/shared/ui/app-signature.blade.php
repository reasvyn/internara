...
<div class="text-center py-6 border-t border-base-content/5 mt-8">
    <div class="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
        <div class="flex items-center gap-2">
            ...
            <span class="text-xs font-black tracking-tight text-base-content/60">{{ $appName }}</span>
        </div>

        <div class="hidden sm:block size-1 rounded-full bg-base-content/10"></div>

        <x-mary-badge :value="$appVersion" class="badge-neutral font-black text-[9px] uppercase px-2 py-0 h-4 border-none opacity-50" />
        ...
        <span class="text-[10px] font-black uppercase tracking-widest text-base-content/20">{{ $appLicense }} License</span>
    </div>
</div>
