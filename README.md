<p align="center">
    <img src="https://img.shields.io/badge/version-0.15.3-blue?style=flat-square" alt="Version 0.15.3">
...
**Phase: v0.15.3 — TallstackUI Complete** (in progress). 18 modules with full stack (models, actions,
