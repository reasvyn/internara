...
return [
    ...
    'delete_selected_confirm' =>
        'Apakah Anda yakin ingin menghapus jurusan yang dipilih? Hanya jurusan tanpa siswa yang akan dihapus.',
    'confirm_delete_selected' =>
        'Apakah Anda yakin ingin menghapus jurusan yang dipilih? Hanya jurusan tanpa siswa yang akan dihapus.',
    'confirm_delete' =>
        'Apakah Anda yakin ingin menghapus jurusan ini? Hanya jurusan tanpa siswa yang akan dihapus.',
    'cannot_delete_with_profiles' =>
        'Jurusan ini tidak dapat dihapus karena masih memiliki profil siswa terkait.',
    ...
    'save' => 'Simpan',
    'delete_success_bulk' =>
        '{0} Tidak ada jurusan yang dihapus|{1} 1 jurusan dihapus|[2,*] :count jurusan dihapus.',
    'delete_blocked_bulk' =>
        '{0} Tidak ada jurusan yang dilewati|{1} 1 jurusan dilewati (memiliki profil)|[2,*] :count jurusan dilewati (memiliki profil).',
    ...
    'template_example_description' =>
        'contoh: Jurusan yang berfokus pada pengembangan perangkat lunak',
    ...
    'guide' => [
        ...
        'create_desc' =>
            'Buat jurusan baru dengan nama dan deskripsi. Nama jurusan harus unik dalam sistem.',
        'edit_title' => 'Mengubah Jurusan',
        'edit_desc' =>
            'Perbarui nama atau deskripsi jurusan yang sudah ada. Perubahan langsung diterapkan di seluruh sistem.',
        'import_title' => 'Impor CSV',
        'import_desc' =>
            'Impor banyak jurusan sekaligus dari file CSV. Kolom pertama: nama, kolom kedua: deskripsi (opsional).',
        'delete_title' => 'Menghapus Jurusan',
        'delete_desc' =>
            'Jurusan yang masih memiliki profil siswa tidak dapat dihapus. Pindahkan siswa terlebih dahulu jika perlu.',
    ],
];
