...
return [
    ...
    'super_admin_recovered' => [
        ...
        'broadcast' => 'Super admin account :email has been recovered',
        'database' => 'Super admin account :email has been recovered',
    ...
    'recovery_otp' => [
        'mail_subject' => 'Super Admin Recovery: One-Time Code',
