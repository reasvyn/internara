        ...
        >
            <main class="flex w-full max-w-lg flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    {{-- Light Mode 12 SVG --}}
                    <svg
                        class="w-md relative -ms-8 -mt-[4.9rem] max-w-none lg:-mt-[6.6rem] lg:ms-0 dark:hidden"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    {{-- Dark Mode 12 SVG --}}
                    <svg
                        class="w-md relative -ms-8 -mt-[4.9rem] hidden max-w-none lg:-mt-[6.6rem] lg:ms-0 dark:block"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
