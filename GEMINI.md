...
## Architecture & Design
- **Architecture Model:** Modular Monolith (documented in [docs/architecture.md](docs/architecture.md)).
- **Primary Stack:** Laravel, Livewire, Tailwind CSS.
- **Dependency Injection:** Automated service registration via `BindServiceProvider` scanning module contracts.
- **Cross-Module Communication:** Strictly via service contracts; no direct model imports or cross-module foreign key constraints.
