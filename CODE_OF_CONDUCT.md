...
> standards. This Code of Conduct applies to all spaces managed by the Internara project, including
> repositories, issue trackers, and GitHub Discussions.

---

## 1. Our Pledge (ISO 26000 Alignment)

In the interest of fostering an open, welcoming, and strictly professional engineering environment,
we as contributors and maintainers pledge to make participation in our project a harassment-free
...
We prioritize **Technical Merit** and **Professional Integrity** above all else.

---

## 2. Standards of Conduct (Behavioral Invariants)
...
## 3. Unacceptable Behavior (Violations)

The following behaviors are considered violations of this Code of Conduct:

- **Harassment**: Public or private harassment, including offensive verbal comments, intimidation,
  or stalking.
- **Sexual Attention**: Unwelcome sexual attention or advances.
- **Trolling**: Deliberate disruption of discussions, inflammatory comments, or "bad faith"
  arguments.
- **Doxxing**: Publishing others' private information without explicit permission.
- **Spam**: Excessive self-promotion or automated posting.
...
the project team at **[reasvyn@gmail.com](mailto:reasvyn@gmail.com)**. All complaints will be
...
- **Permanent Ban**: A permanent ban from all project spaces for serious or repeated violations.

---

## 5. Attribution

This Code of Conduct is adapted from the **Contributor Covenant**, version 2.1, and enhanced with
ISO-standardized governance terminology suitable for the Internara project.
