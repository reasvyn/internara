...
return [
    ...
    'dashboard' => [
        ...
        'requirements_incomplete' => [
            ...
            'description' =>
                'Please complete the administrative requirements below to proceed with the internship process.',
        ],
        'waiting_placement' => [
            'title' => 'Waiting for Placement',
            'description' => 'Your administrative requirements are complete.',
            'extra' =>
                'Please wait for the admin/coordinator to place you at an internship location.',
        ],
    ...
    'manager' => [
        ...
        'form' => [
            'password_setup_notice' =>
                'Student accounts should not be managed through administrator-known passwords. Save the record first, then send a secure access setup link.',
            'password_reset_notice' =>
                'Use the send-setup-link action from the table to reset student access securely without viewing the password.',
            'archive_hint' =>
                'For annual archiving, prefer setting students to Inactive so their history remains preserved.',
        ],
    ],
];
