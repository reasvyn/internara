...
return [
    ...
    'unauthorized_setup_access' =>
        'Akses penyiapan tidak sah. Silakan gunakan tautan bertanda tangan yang disediakan oleh CLI.',
    ...
    'conflict' =>
        'Permintaan tidak dapat diselesaikan karena adanya konflik dengan status sumber daya saat ini.',
