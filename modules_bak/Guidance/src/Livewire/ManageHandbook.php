...
class ManageHandbook extends RecordManager
{
    ...
    public function initialize(): void
    {
        ...
        $this->viewPermission = Permission::GUIDANCE_MANAGE;
        $this->createPermission = Permission::GUIDANCE_MANAGE;
        $this->updatePermission = Permission::GUIDANCE_MANAGE;
        $this->deletePermission = Permission::GUIDANCE_MANAGE;
