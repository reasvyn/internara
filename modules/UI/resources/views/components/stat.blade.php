@props([
    ...
    'icon' => null,
    'description' => null,
    'priority' => 'primary', // primary, secondary, accent, info, success, warning, error
    'aos' => 'fade-up',
])
