<div>
        ...
        >
                    <x-slot:actions wire:key="user-manager-actions">
        ...
        <x-ui::modal wire:model="formModal" :title="$form->id ? __('user::ui.manager.edit_' . $roleKey) : __('user::ui.manager.add_' . $roleKey)">
            <x-ui::form wire:submit="save">
                ...
                @if($targetRole === 'student')
                    <x-ui::input :label="__('user::ui.manager.form.identity_number')" icon="tabler.id" wire:model="form.profile.identity_number" placeholder="Nomor Induk Siswa Nasional" />
