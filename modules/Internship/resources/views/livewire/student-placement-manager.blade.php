                            ...
                            <tr>
                                ...
                                <td>
                                    @if($registration->placement_company !== '-')
                                        {{ $registration->placement_company }}
                                    @elseif($registration->proposed_company_name)
                                        <div class="flex flex-col">
                                            <span class="text-xs font-bold text-warning uppercase">{{ __('internship::ui.propose_new_partner') }}</span>
                                            <span>{{ $registration->proposed_company_name }}</span>
                                        </div>
                                    @else
                                        -
                                    @endif
