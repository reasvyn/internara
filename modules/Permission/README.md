...
- **Authorization:** Defines granular access for Instructor, Staff, Student, and Industry Supervisor roles.
...
- **[RBAC Infrastructure](../../docs/internal/role-permission-management.md)**: Standardized modular access.
...
- **[UI Components](../../docs/internal/permission-ui-components.md)**: Shared role/permission selectors.

---

_The Permission module is the security heart of Internara, ensuring that every action is authorized._