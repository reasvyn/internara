...
- _Features_: Key-based and group-based retrieval, automated type casting, and proactive caching.
...
- _Casting_: Utilizes `SettingValueCast` to ensure values are returned as correct PHP types (string,
