...
return [
    'reset' => [
        ...
        'production_warning' =>
            'Sistem berada di lingkungan PRODUKSI. Mereset pengaturan sangat destruktif dan memerlukan flag --force.',
        'confirm_question' =>
            'Tindakan ini akan membuka akses rute setup dan memungkinkan konfigurasi ulang. Lanjutkan?',
        'tasks' => [
        ...
        'link_label' =>
            'Tautan akses aman sekali pakai telah dibuat (Kedaluwarsa dalam :minutes menit):',
