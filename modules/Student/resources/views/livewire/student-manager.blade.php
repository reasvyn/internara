                ...
                <div class="w-[min(92vw,35rem)] space-y-8 p-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <x-ui::select
                            ...
                            icon="tabler.topology-star-ring"
        ...
        <x-slot:formFields>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-4">
                <div class="space-y-6">
                    ...
                    <div class="p-6 bg-base-200/50 rounded-3xl border border-base-content/5 space-y-4">
                        <h4 class="text-[10px] font-black uppercase tracking-[0.2em] opacity-40">{{ __('user::ui.manager.form.identity_number') }}</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-ui::input :label="__('user::ui.manager.form.nisn')" wire:model="form.profile.national_identifier" placeholder="0012345678" />
                            <x-ui::input :label="__('user::ui.manager.form.nis')" wire:model="form.profile.registration_number" placeholder="2024.12345" />
                        </div>
                    </div>
                </div>

                <div class="space-y-6">
                    <x-ui::select :label="__('user::ui.manager.form.department')" icon="tabler.topology-star-ring" wire:model="form.profile.department_id" :options="$this->departmentOptions" required />
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <x-ui::select :label="__('user::ui.manager.form.gender')" icon="tabler.gender-intersex" wire:model="form.profile.gender" :options="[['id' => 'male', 'name' => __('ui::common.male')], ['id' => 'female', 'name' => __('ui::common.female')]]" />
