        ...
        'assessment' => [
            ...
            'items' => [
                ...
                [
                    ...
                    'label' => 'sidebar.presentations',
                ],
                [
                    'route' => 'sysadmin.evaluations',
                    'icon' => 'o-star',
                    'label' => 'sidebar.evaluations',
                ],
            ],
        ],
        ...
        'student_portal' => [
            ...
            'items' => [
                ...
                [
                    ...
                    'icon' => 'o-arrows-right-left',
                    'label' => 'sidebar.request_placement_change',
                ],
                [
                ...
                [
                    ...
                    'label' => 'sidebar.handbooks',
                ],
                [
                    'route' => 'registration.center',
                    'icon' => 'o-briefcase',
                    'label' => 'sidebar.browse_programs',
                ],
                [
                    'route' => 'registration.wizard',
                    'icon' => 'o-document-plus',
                    'label' => 'sidebar.register_internship',
                ],
                [
        ...
        'teacher_portal' => [
            ...
            'items' => [
                ...
                [
                    ...
                    'icon' => 'o-clipboard-document-list',
                    'label' => 'sidebar.assess',
                ],
                [
                    'route' => 'supervision.logs',
                    'icon' => 'o-clipboard-check',
                    'label' => 'sidebar.guidance_logs',
                ],
            ],
        ],
        ...
        'reports' => [
            ...
            'items' => [
                ...
                [
                    ...
                    'icon' => 'o-document-duplicate',
                    'label' => 'sidebar.certificate_templates',
                ],
                [
                    'route' => 'sysadmin.accounts.lifecycle',
                    'icon' => 'o-arrow-path',
                    'label' => 'sidebar.account_lifecycle',
                ],
                [
                    'route' => 'sysadmin.gdpr-logs',
                    'icon' => 'o-shield-exclamation',
                    'label' => 'sidebar.gdpr_logs',
                ],
            ],
        ],
