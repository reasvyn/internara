...
return [
    ...
    */
    'timeouts' => [
        'super_admin' => env('SESSION_TIMEOUT_SUPER_ADMIN', 12 * 60), // 12 hours in minutes
        'admin' => env('SESSION_TIMEOUT_ADMIN', 12 * 60), // 12 hours in minutes
        'teacher' => env('SESSION_TIMEOUT_TEACHER', 24 * 60), // 24 hours in minutes
        'supervisor' => env('SESSION_TIMEOUT_SUPERVISOR', 24 * 60), // 24 hours in minutes
        'student' => env('SESSION_TIMEOUT_STUDENT', 24 * 60), // 24 hours in minutes
        'default' => env('SESSION_TIMEOUT_DEFAULT', 24 * 60), // 24 hours in minutes
    ],
