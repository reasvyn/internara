...
**Example:** Auth module has submodules under `app/Domain/Auth/Password/`, `app/Domain/Auth/Login/`, etc.
User module will have `app/User/Profile/`, `app/User/Notification/`.
