...
- Tests follow module-first, submodule-based structure:
  `tests/{Feature,Unit}/{Module}/{Submodule}/{Name}Test.php`.
- Shared component tests: `tests/{Feature,Unit}/{Component}/{Name}Test.php` (e.g.,
  `tests/Unit/Data/AuditDtoTest.php`).
...
- Views for shared components: `resources/views/{component}/{component-name}.blade.php` (e.g.,
  `resources/views/livewire/lang-switcher.blade.php`)
