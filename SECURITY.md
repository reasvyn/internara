...
- **Mandatory Policies:** Every model MUST have a Policy class enforcing **Role-Based Access Control**.
- **User Roles:** Access is restricted to the roles mandated by the specs (Instructor, Staff, Student, Industry Supervisor).

### 2. Data Isolation & Integrity
- **Module Isolation:** **No physical foreign keys** between modules. Integrity managed via Services.
