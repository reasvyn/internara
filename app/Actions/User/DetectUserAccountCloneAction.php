...
/**
 * Detects potential duplicate or cloned user accounts.
 *
 * Identifies accounts sharing the same email address, which may indicate
 * data entry errors, account cloning attempts, or legacy data issues.
 *
...
class DetectUserAccountCloneAction
{
     ...
     *
     * Returns a collection of arrays containing the duplicate email,
     * type identifier, and list of user IDs sharing that email.
     *
