...
namespace App\Domain\Assessment\Aggregates\Presentation\Livewire;

use App\Domain\Assessment\Aggregates\Presentation\Actions\SchedulePresentationAction;
use App\Domain\Assessment\Aggregates\Presentation\Actions\ScorePresentationAction;
use App\Domain\Assessment\Aggregates\Presentation\Enums\PresentationStatus;
...
class PresentationSchedule extends BaseRecordManager
{
    ...
    {
        return view('assessment.presentation.presentation-schedule', [
