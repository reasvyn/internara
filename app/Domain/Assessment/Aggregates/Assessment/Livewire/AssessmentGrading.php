...
namespace App\Domain\Assessment\Aggregates\Assessment\Livewire;

use App\Domain\Assessment\Aggregates\Assessment\Actions\AutoCalculateAssessmentAction;
use App\Domain\Assessment\Aggregates\Assessment\Actions\FinalizeAssessmentAction;
use App\Domain\Assessment\Aggregates\Assessment\Actions\InitializeAssessmentAction;
use App\Domain\Assessment\Aggregates\Assessment\Actions\UpdateAssessmentScoresAction;
...
class AssessmentGrading extends Component
{
    ...
    {
        return view('assessment.assessment.assessment-grading');
    }
}
