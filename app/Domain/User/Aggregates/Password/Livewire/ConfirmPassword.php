...
namespace App\Domain\User\Aggregates\Password\Livewire;

use App\Domain\Core\Support\SmartLogger;
use App\Domain\User\Aggregates\Password\Actions\ConfirmPasswordAction;
use App\Domain\User\Aggregates\Password\Livewire\Forms\ConfirmPasswordForm;
...
class ConfirmPassword extends Component
{
    ...
    {
        return view('user.password.confirm-password');
    }
}
