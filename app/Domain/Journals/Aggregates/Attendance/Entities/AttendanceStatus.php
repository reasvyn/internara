...
namespace App\Domain\Journals\Aggregates\Attendance\Entities;

use App\Domain\Core\Entities\BaseEntity;
use App\Domain\Journals\Aggregates\Attendance\Enums\AttendanceStatus as AttendanceStatusEnum;
use Carbon\Carbon;
