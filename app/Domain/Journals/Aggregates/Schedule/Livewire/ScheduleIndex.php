...
namespace App\Domain\Journals\Aggregates\Schedule\Livewire;

use App\Domain\Journals\Aggregates\Schedule\Actions\CreateScheduleAction;
use App\Domain\Journals\Aggregates\Schedule\Actions\DeleteScheduleAction;
use App\Domain\Journals\Aggregates\Schedule\Actions\UpdateScheduleAction;
...
class ScheduleIndex extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('journals.schedule.schedule-index', [
            'schedules' => $schedules,
        ]);
    }
}
