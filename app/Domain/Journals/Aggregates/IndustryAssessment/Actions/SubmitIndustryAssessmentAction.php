...
namespace App\Domain\Journals\Aggregates\IndustryAssessment\Actions;

use App\Domain\Core\Actions\BaseAction;
use App\Domain\Enrollment\Models\Registration;
use App\Domain\Journals\Aggregates\IndustryAssessment\Models\IndustryAssessment;
...
final class SubmitIndustryAssessmentAction extends BaseAction
{
     ...
     */
    public function execute(Registration $registration, User $supervisor, ?array $rubricData, ?string $notes): IndustryAssessment
    {
        return $this->transaction(function () use ($registration, $supervisor, $rubricData, $notes) {
            $score = null;
