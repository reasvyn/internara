...
use App\Domain\Reports\Aggregates\Report\Actions\ApproveReportAction;
use App\Domain\Reports\Aggregates\Report\Actions\RequestReportRevisionAction;
...
class ReportReview extends BaseRecordManager
{
    ...
    {
        return view('guidance.mentor.report.review', [
