...
use App\Actions\Briefing\CreateBriefingAction;
use App\Actions\Briefing\OverrideBriefingAttendanceAction;
use App\Actions\Briefing\RecordBriefingAttendanceAction;
...
class BriefingManager extends BaseRecordManager
{
    ...
    {
        return view('livewire.internship.briefing-manager');
    }
}
