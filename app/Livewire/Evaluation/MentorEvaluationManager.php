...
use App\Models\Evaluation\MentorEvaluation;
use App\Models\User;
...
class MentorEvaluationManager extends Component
{
    ...
    public ?MentorEvaluation $editingEvaluation = null;
    ...
    public function edit(MentorEvaluation $evaluation): void
    {
    ...
    public function delete(MentorEvaluation $evaluation): void
    {
        $evaluation->delete();
    ...
    {
        $evaluations = MentorEvaluation::query()
