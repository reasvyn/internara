 ...
 *   - module:  the owning bounded context (e.g., setup, admin, theme)
 ...
 *   medium = 5 min - 1 hour  (dashboard submodules)
...
final readonly class CacheKeys
{
    ...
    public const string MODULE_LIVEWIRE = 'module.discovered_livewire';

    public const string MODULE_POLICIES = 'module.discovered_policies';

    public const string MODULE_VIEWS = 'module.discovered_views';
