...
use App\SysAdmin\SuperAdmin\Actions\InitializeSuperAdminAction;
...
class CreateAdminCommand extends Command
{
    ...
    public function __construct(private InitializeSuperAdminAction $action)
    {
        parent::__construct();
        ...
        $email =
            ...
            text(
                ...
                validate: fn (string $value) => ! filter_var($value, FILTER_VALIDATE_EMAIL)
                    ? __('sysadmin.create.invalid_email')
                    : null,
            );
        ...
        $password =
            ...
            password(
                ...
                validate: fn (string $value) => strlen($value) < 8
                    ? __('sysadmin.create.password_min')
                    : null,
            );
