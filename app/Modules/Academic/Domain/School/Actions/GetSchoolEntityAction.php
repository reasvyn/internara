...
namespace App\Modules\Academic\Domain\School\Actions;
...
/**
 * Read the school profile entity from the Setting store.
 *
 * Encapsulates Setting::get() so that SchoolEntity remains pure
...
final class GetSchoolEntityAction extends BaseReadAction
{
     ...
     *
     * Single batch query via Setting::get(array_values(keys)).
    ...
    public function execute(): SchoolEntity
    {
        ...
        // Setting Services is cross-module; Action is the allowed boundary via public surface,
