...
namespace App\Modules\Academic\Domain\School\Entities;
...
final readonly class SchoolEntity extends BaseEntity
{
    ...
    /**
     * Hydrate from a Setting::get() result array.
     *
    ...
    /**
     * Legacy getter — reads via Setting store.
     *
     * Kept for spec FR-SP3 backward compat. Prefer GetSchoolEntityAction
     * for new code to respect module boundaries (Entity → Setting is
