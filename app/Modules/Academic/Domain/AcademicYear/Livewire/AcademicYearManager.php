...
namespace App\Modules\Academic\Domain\AcademicYear\Livewire;
...
use App\Modules\Academic\Domain\AcademicYear\Livewire\Forms\AcademicYearForm;
...
class AcademicYearManager extends BaseRecordManager
{
    ...
    {
        return view('academic.academic-year.academic-year-manager', [
            'years' => $this->rows(),
            'stats' => $this->stats,
        ]);
    }
