...
namespace App\Modules\Journal\Domain\AbsenceRequest\Livewire;
...
class AbsenceRequestForm extends BaseFormView
{
    ...
    public function submit(SubmitAbsenceAction $action): void
    {
        ...
        $this->handleSave(function () use ($registration, $action) {
            ...
            $this->toast()->success(__('journal.absence.submitted'))->send();
        });
    }
    ...
    {
        return view('journal.absence-request.absence-request-form', [
