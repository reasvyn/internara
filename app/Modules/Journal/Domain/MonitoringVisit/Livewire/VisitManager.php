...
namespace App\Modules\Journal\Domain\MonitoringVisit\Livewire;
...
class VisitManager extends BaseRecordManager
{
    ...
    {
        return [
            ['index' => 'visit_date', 'label' => __('journal.visit_date'), 'sortable' => true],
            ['index' => 'teacher.name', 'label' => __('journal.teacher')],
            ['index' => 'method', 'label' => __('journal.method')],
            ['index' => 'location', 'label' => __('journal.location')],
            ['index' => 'is_verified', 'label' => __('journal.status')],
    ...
    public function save(CreateVisitAction $action): void
    {
        ...
        $this->toast()->success(__('journal.visit_created'))->send();
    ...
    private function executeVerify(string $id, VerifyVisitAction $action): void
    {
        ...
        $this->toast()->success(__('journal.visit_verified'))->send();
    }

    #[Layout('ui::layouts.app')]
    public function render(): View
    {
        return view('journal.monitoring-visit.visit-manager');
    }
}
