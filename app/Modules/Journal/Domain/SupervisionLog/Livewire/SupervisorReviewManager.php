...
class SupervisorReviewManager extends BaseRecordManager
{
    ...
    {
        return [
            ['index' => 'registration.student.name', 'label' => __('journal.student'), 'sortable' => true],
    ...
    public function confirmReview(ReviewLogAction $action): void
    {
        ...
        try {
            ...
            $this->toast()->success(__('journal.log_reviewed'))->send();
    ...
    {
        return view('journal.supervision-log.supervisor-review-manager');
    }
}
