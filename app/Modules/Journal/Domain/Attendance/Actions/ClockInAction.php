...
use App\Modules\Journal\Domain\Attendance\Events\AttendanceClockIn;
...
final class ClockInAction extends BaseCommandAction
{
    public function execute(ClockInData $data): Attendance
    {
        return $this->transaction(function () use ($data) {
            ...
            if (! $registration) {
                throw new RejectedException(__('journal.no_active_registration'));
            }
            ...
            if ($existingLog) {
                throw new RejectedException(__('journal.attendance.already_clocked_in'));
            }
