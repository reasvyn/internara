...
test('SE5Q9-FR-A6: execute() wraps the mutation in a transaction that commits', function () {
...
test('SE5Q9-FR-A7: execute() logs a successful mutation to the activity log', function () {
