...
it('FR-A4: step() records success and returns the step result', function () {
...
it('FR-A4: step() records failure and rethrows the exception', function () {
    $action = new TestProcessAction;
...
it('FR-A4: trackProgress() clamps the percentage between 0 and 100', function () {
    $action = new TestProcessAction;
...
it('FR-A4: allStepsSucceeded() reflects every step outcome', function () {
    $action = new TestProcessAction;
...
it('FR-A4: notify() sends through the Notification facade', function () {
...
it('FR-A4: logProgress() writes progress and step results to the system log', function () {
    $logs = captureLogs();
    $action = new TestProcessAction;
