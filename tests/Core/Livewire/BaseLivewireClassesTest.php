...
test('SE5Q9-FR-L1: BaseRecordManager rows() paginates with a valid perPage', function () {
...
test('SE5Q9-FR-L1: BaseRecordManager falls back to 10 for invalid perPage values', function () {
    $component = new BaseRecordManagerTestStub;
    $component->perPage = 7;
...
test('SE5Q9-FR-L1: BaseRecordManager applies search and eager loading', function () {
...
test('SE5Q9-FR-L1: BaseRecordManager resetFilters clears filters and updates reset the page', function () {
    $component = new BaseRecordManagerTestStub;
...
test('SE5Q9-FR-L1: bulk action warns when no records are selected', function () {
    $component = new BaseRecordManagerTestStub;
    $called = 0;
...
test('SE5Q9-FR-L1: bulk action runs the callback per selected id and clears selection', function () {
    $component = new BaseRecordManagerTestStub;
...
test('SE5Q9-FR-L1: mass action warns when no records match the query', function () {
    $component = new BaseRecordManagerTestStub;
...
test('SE5Q9-FR-L1: mass action runs the callback with the filtered query and clears selection', function () {
...
test('SE5Q9-FR-L3: BaseRecordList rows() paginates and searches', function () {
...
test('SE5Q9-FR-L3: BaseRecordList falls back to 10 for invalid perPage values', function () {
    $component = new BaseRecordListTestStub;
...
test('SE5Q9-FR-L2: BaseRecordEntry create() resets the form and opens the modal', function () {
...
test('SE5Q9-FR-L2: BaseRecordEntry edit() opens the modal with the record id', function () {
    $component = new BaseRecordEntryTestStub;
...
test('SE5Q9-FR-L2: BaseRecordEntry cancel() closes the modal and resets the form', function () {
    $component = new BaseRecordEntryTestStub;
...
test('SE5Q9-FR-L2: handleError catches RejectedException and generic errors without propagating', function () {
    $component = new BaseRecordEntryTestStub;
    $ran = false;
...
test('SE5Q9-FR-L4: BaseFormView handleSave clears dirty state on success and flags errors otherwise', function () {
...
test('SE5Q9-FR-L4: markDirty flags the form as modified', function () {
    $component = new BaseFormViewTestStub;
...
test('SE5Q9-FR-L5: BaseWizard nextStep validates, marks completed and advances', function () {
...
test('SE5Q9-FR-L5: BaseWizard prevStep moves back but never below step one', function () {
    $component = new BaseWizardTestStub;
...
test('SE5Q9-FR-L5: goToStep enforces range and accessibility', function () {
    $component = new BaseWizardTestStub;
...
test('SE5Q9-FR-L5: isStepAccessible requires all prior steps to be completed', function () {
    $component = new BaseWizardTestStub;
...
test('SE5Q9-FR-L5: progressPercent reflects position across steps', function () {
    $component = new BaseWizardTestStub;
...
test('SE5Q9-FR-L5: currentStepKey returns the key of the active step', function () {
    $component = new BaseWizardTestStub;
...
test('SE5Q9-FR-L5: handleStepError catches RejectedException and generic errors', function () {
    $component = new BaseWizardTestStub;
    $ran = false;
