...
it('SE5Q9-FR-D3: every case has a non-empty translated label', function () {
    foreach (AuditCategory::cases() as $case) {
        expect($case->label())->toBeString()->not->toBeEmpty();
    }
});

it('SE5Q9-FR-D3: implements the LabelEnum contract', function () {
    expect(AuditCategory::class)->toImplement(LabelEnum::class);
});

it('SE5Q9-FR-D3: marks critical categories as critical', function () {
