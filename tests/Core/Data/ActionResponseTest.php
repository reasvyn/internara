...
it('SE5Q9-FR-M5: ok() returns a successful response with data and message', function () {
...
it('SE5Q9-FR-M5: created() and updated() default their messages', function () {
    expect(ActionResponse::created()->message)->toBe(__('common.created'));
    expect(ActionResponse::updated()->message)->toBe(__('common.updated'));
});

it('SE5Q9-FR-M5: deleted() returns a successful response', function () {
...
it('SE5Q9-FR-M5: error() returns a failed response with errors', function () {
...
it('SE5Q9-FR-M5: withRedirect() preserves the response and sets the redirect', function () {
...
it('SE5Q9-FR-M5: jsonSerialize omits empty and null values', function () {
...
it('SE5Q9-FR-M5: jsonSerialize converts Eloquent models to arrays', function () {
