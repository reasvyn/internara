...
describe('7C5WM: InternshipStatus enum', function (): void {
    test('7C5WM-FR-LIFE-013: cases carry the specified backing values', function (): void {
        ...
        expect(InternshipStatus::cases())->toHaveCount(5);
    ...
    test('7C5WM-FR-LIFE-013: completed and cancelled are terminal', function (): void {
    ...
    test('7C5WM-FR-LIFE-013: validTransitions pins the lifecycle map', function (): void {
    ...
    test('7C5WM-FR-LIFE-007: status updates validate through canTransitionTo', function (): void {
