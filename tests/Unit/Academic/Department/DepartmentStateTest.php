...
use App\Modules\Academic\Domain\Department\Entities\DepartmentState;
...
describe('4HWSB: department state', function (): void {
    ...
    test('4HWSB-FR-DEPT-004: fromModel report zero profiles when the relation is empty', function (): void {
