...
test('theme switcher renders', function () {
    Livewire::test(ThemeSwitcher::class)
        ...
        ->assertViewIs('settings.livewire.theme-switcher');
});

test('theme switcher defaults to system', function () {
    Livewire::test(ThemeSwitcher::class)->assertSet('theme', 'system');
});
...
test('theme switcher ignores invalid theme', function () {
    Livewire::test(ThemeSwitcher::class)->call('setTheme', 'invalid')->assertSet('theme', 'system');
});
