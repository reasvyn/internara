...
test('IT0OE-FR-MM9: AddMembersToGroupAction creates all rows with joined_at = now()', function () {
...
test('IT0OE-FR-MM9: AddMembersToGroupAction rolls back the whole batch on DB constraint violation', function () {
    $group = InternshipGroup::factory()->create();
...
test('IT0OE-FR-MM9: AddMembersToGroupAction supports mentor roles in the batch', function () {
    $group = InternshipGroup::factory()->create();
