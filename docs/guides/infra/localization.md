...
- `app/Modules/Setting/Domain/Locale/Http/Middleware/SetLocaleMiddleware.php` — locale detection
- `app/Modules/Setting/Domain/Locale/Livewire/LangSwitch.php` — UI language toggle
