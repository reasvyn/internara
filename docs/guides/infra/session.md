...
| Duration    | Impact                                                      |
| ----------- | ----------------------------------------------------------- |
| < 30 min    | Forces frequent re-auth, disrupts long work sessions        |
...
After expiry, the user is redirected to login.
...
```php
// app/Modules/Setting/Domain/Locale/Http/Middleware/SetLocaleMiddleware.php
...
- `app/Modules/Setting/Domain/Locale/Http/Middleware/SetLocaleMiddleware.php` — locale persistence
