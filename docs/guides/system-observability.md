...
- `app/Modules/Core/Services/SmartLogger.php` — SmartLogger implementation
...
- `app/Modules/SysAdmin/Domain/Observability/Console/Commands/SystemHealthCommand.php` — Health command
- `app/Modules/SysAdmin/Domain/Observability/Console/Commands/SystemCleanupCommand.php` — Cleanup command
