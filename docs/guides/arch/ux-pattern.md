...
- `app/Modules/Setting/Domain/Theme/Support/Theme.php` + `app/Modules/Core/Support/Color.php` — `cssVariables()`, `contrastColor()`, `computeDarkShades()`, `isValid()`
- `app/Modules/Setting/Domain/Locale/Http/Middleware/SetLocaleMiddleware.php` + `config/app.php` + `config/localization.php` — locale plumbing
