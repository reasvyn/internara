...
- `app/Modules/SysAdmin/Domain/Observability/Console/Commands/SystemHealthCommand.php` — Health check implementation
- `app/Modules/SysAdmin/Domain/Observability/Console/Commands/SystemCleanupCommand.php` — Cleanup implementation
