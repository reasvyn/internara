...
Internara uses a centralized, immutable audit trail system to track critical user and system
activities. This system is designed to meet S1 (Secure) requirements by providing a forensic record
of changes.
...
2. **PII Masking**: Sensitive information (passwords, private tokens) must be masked before being
