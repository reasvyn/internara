...
Internara uses Laravel's database abstraction layer with support for multiple database drivers. The primary development database is **SQLite**, with production support for **MySQL** and **PostgreSQL**.
