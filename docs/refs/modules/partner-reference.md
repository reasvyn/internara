...
Detailed structural and implementation reference for the **Partner** module.
...
File: `routes/web/partner.php` Naming pattern: `partner.companies`, `partner.partnerships`

## Views

Views are located in `resources/views/partner/`. See [UI/UX](../../guides/ui-ux/design-system.md) for the design
system.

## Tests

Tests are located in `tests/{Type}/Partner/` (Arch, Unit, Feature, Browser). See [Testing](../../guides/infra/testing.md)
...
- **Business Logic**: `app/Modules/Partner/`
- **Routing**: `routes/web/partner.php`
- **Views**: `resources/views/partner/`
- **Testing**: `tests/{Type}/Partner/`
- **Dependencies**: Core
- **Used By**: Program

_For overview and business context, see [partner.md](partner.md)._
