...
Detailed structural and implementation reference for the **Academic** module.
...
| File                                                | Class                | Purpose                                                          |
| --------------------------------------------------- | -------------------- | ---------------------------------------------------------------- |
| `AcademicYear/Support/AcademicYearPeriod.php`       | `AcademicYearPeriod` | Active school-year computation (July–June convention), shared by seeders and setting UI (FR-AY40) |
...
File: `routes/web/academic.php` Named routes: `sysadmin.school`, `sysadmin.departments`,
`sysadmin.academic-years`

## Views

Views are located in `resources/views/academic/`. See [UI/UX](../../guides/ui-ux/design-system.md) for the
design system.

## Tests

Tests are located in `tests/{Type}/Academic/` (Arch, Unit, Feature, Browser). See [Testing](../../guides/infra/testing.md)
...
- **Business Logic**: `app/Modules/Academic/`
- **Routing**: `routes/web/academic.php`
- **Views**: `resources/views/academic/`
- **Testing**: `tests/{Type}/Academic/`
...
_For overview and business context, see [academic.md](academic.md)._
