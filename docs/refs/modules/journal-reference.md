...
Detailed structural and implementation reference for the **Journal** module.
...
File: `routes/web/journal.php` Named routes: `student.logbook`, `student.attendance`,
...
Views are located in `resources/views/journal/`. See [UI/UX](../../guides/ui-ux/design-system.md) for the design
system.

## Tests

Tests are located in `tests/{Type}/Journal/` (Arch, Unit, Feature, Browser). See [Testing](../../guides/infra/testing.md)
...
- **Business Logic**: `app/Modules/Journal/`
- **Routing**: `routes/web/journal.php`
- **Views**: `resources/views/journal/`
- **Testing**: `tests/{Type}/Journal/`
- **Dependencies**: Enrollment, Program, Core
- **Used By**: Evaluation, Report

_For overview and business context, see [journal.md](journal.md)._
