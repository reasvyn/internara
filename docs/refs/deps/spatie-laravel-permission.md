...
- Five flat roles (Super Admin excluded via `Gate::before`) — hierarchy documented in
  [`foundation/rbac.md`](../../foundation/rbac.md)
...
- [`docs/foundation/rbac.md`](../../foundation/rbac.md) — Internara's role model
- [`docs/architecture/policy-pattern.md`](../../architecture/policy-pattern.md) — three-layer authorization
