...
This command runs every minute via the cron scheduler. When a scheduled announcement's time arrives,
it is automatically published and delivered to all targeted users.
...
Select multiple notifications and choose **Delete Selected** to remove them. This action cannot be
undone.
...
The unread count is cached for 60 seconds. Wait a moment and refresh the page. If the count is still
wrong, it will update automatically when you view the Notification Center.
...
**← Previous: [Chapter 20: Evaluation & Incident](20-evaluation-and-incident.md)** **Next:
[Chapter 22: System Observability](22-system-observability.md)**
