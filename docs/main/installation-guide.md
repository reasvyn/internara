...
Welcome to Internara! This guide is designed to help you—whether you are a school administrator, an
institution IT staff member, or a curious user—set up the Internara platform on your local machine
or server.
...
_Note: You can customize your application name and database connection inside the `.env` file._
...
Open your browser and go to `http://localhost:8000`. If you see the Internara welcome page, your
