...
- `docs/en/known-issues.md` — SQLite vs MySQL differences catalog
- `docs/en/erd/00-erd-index.md` — complete ERD documentation (75 tables)
- `docs/en/adr/adr-007-sqlite-as-default-database.md` — rationale for SQLite default
