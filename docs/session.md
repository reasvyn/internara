...
Internara uses Laravel's session management for maintaining user state across requests. The system
supports multiple session drivers with **Database** as the default for production and **Array** for
testing.
