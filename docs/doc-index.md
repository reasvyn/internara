...
> Last updated: 2026-06-01 Changes: added comprehensive Core domain overview (context boundaries &
> rules)
...
- **Reference** (`docs/domain/{domain}-reference.md`) — Actions, Models, Enums, Entities, Policies,
  Livewire components
