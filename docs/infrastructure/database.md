...
The schema encompasses approximately 50 tables (including both domain-specific tables and framework/package tables such as cache, sessions, jobs, media, notifications, and activity logs).
