...
> **[Internara Specs](../internal/internara-specs.md)** (e.g., UUID identity, Mobile-First structure).
...
```
- **Goal:** Synchronize the User Roles defined in **[Internara Specs](../internal/internara-specs.md)** across the database.
