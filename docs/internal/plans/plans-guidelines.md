...
- The final system state is documented in the **Analytical Version Note**
  (`docs/versions/vX.X.X.md`)
...
> Plans describe **intent**. Narratives describe **outcome**.
...
_Engineering Plans ensure that Internara evolves deliberately rather than accidentally. By defining
intent, exit conditions, and forward direction, the system remains adaptable, comprehensible, and
resilient as complexity grows._
