...
**Purpose**: Decompose the application into dedicated role-based workspaces and implement a formal assessment and certification engine.
...
**Scope**:
The application was functionally rich but "role-confused," with all users sharing a generic dashboard. Furthermore, while activities were tracked, there was no formal mechanism to grade them or issue verifiable certificates.
...
**Feature Set**:
- **Role-Specific Workspaces**: Dedicated dashboards and navigation for Admin, Student, Teacher, and Mentor.
- **Assessment Engine**: Unified scoring system for supervisors and teachers.
- **Verifiable Certificates**: Automated generation of Certificates of Completion with QR code verification.

**User Stories**:
- As a **Mentor**, I want a dedicated space to review my assigned interns so that I can provide feedback efficiently.
...
5. Third-party scans the QR code on the certificate to verify its authenticity via a public landing page.
...
**Multi-Language**:
- All certificates, transcripts, and workspace navigation are fully localized in **Indonesian** and **English**.
...
- **Certification Speed**: Certificates are available for download within 1 second of assessment finalization.
- **Usability**: 30% reduction in support queries related to "where to find" specific features due to dedicated workspaces.
...
- [x] **Verifiable Output**: QR codes on certificates correctly link to the verification landing page.
