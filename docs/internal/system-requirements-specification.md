...
This document constitutes the formal **System Requirements Specification (SyRS)** for the
Internara project, standardized according to **ISO/IEC 29148** (Requirements Engineering). It
establishes the authoritative baseline for all developmental, architectural, and verification
activities.

> **Governance Mandate:** This document is the **Single Source of Truth (SSoT)**. All technical
> modifications, architectural designs, and software artifacts must demonstrate traceability to
...
mentoring of student practical work (internships) within educational institutions and their
industry partners.
...
- **[SYRS-F-101]**: The system shall record student profiles, internship schedules, and institutional
  locations.
...
_This SyRS establishes the authoritative configuration for Internara. Every subsequent engineering
