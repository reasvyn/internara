...
Owns rubric and assessment definitions. Evaluation module consumes assessment results for final scoring. Program provides the context (which program the assessment belongs to). Guidance provides mentor/student relationships used in panel assignments.
