...
Links students (from User module) with mentors and supervisors. Program module provides the program context for mentoring relationships. Journals logs the daily activity that mentors review. SysAdmin manages role assignments that determine who can be a mentor.
...
- **15** actions across all submodules
