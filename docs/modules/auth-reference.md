...
Handles authentication, authorization, account activation, password management, recovery, and super
admin integrity
...
- **Submodules**: `Permissions`, `SuperAdmin`, `Login`, `ActivationToken`, `AccountRecovery`,
  `Password`
- **Business Logic (`app/`)**: Located in
  [app/Auth/](file:///home/reasnovynt/Projects/Dev/reasvyn/internara/app/Auth/)
- **Routing (`routes/`)**:
  [routes/web/auth.php](file:///home/reasnovynt/Projects/Dev/reasvyn/internara/routes/web/auth.php)
- **Views (`views/`)**: Blade templates and layouts are in
  [resources/views/auth/](file:///home/reasnovynt/Projects/Dev/reasvyn/internara/resources/views/auth/)
