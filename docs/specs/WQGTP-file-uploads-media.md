...
|------|-----------------|
| [base-classes.md](SE5Q9-base-classes.md) (SE5Q9) | `BaseCommandAction` for file operation logging |
...
|-------|------|------------|
| 1 | [pdf-generation.md](7UB7S-pdf-generation.md) | Generated PDFs are stored as media via this spec's infrastructure |
