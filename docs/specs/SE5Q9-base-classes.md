...
> **Canonical source:** [logging-and-error-handling.md](89SRA-logging-and-error-handling.md) §4.5
...
**Full specification:** [logging-and-error-handling.md](89SRA-logging-and-error-handling.md) §4.5, §7.1
...
| ------ | ------ | ----------- |
| Strict types | 100% of PHP files (except migrations/config) | `python3 tools/scan_conventions/cli.py` |
| No debug calls | Zero in committed code | `python3 tools/scan_conventions/cli.py` |
| Base class usage | 100% of Actions extend BaseAction variants | `python3 tools/scan_class_contracts/cli.py` |
| Entity contracts | 100% of Entities are `final readonly` with `fromModel()` | `python3 tools/scan_class_contracts/cli.py` |
| DTO contracts | 100% of DTOs extend `BaseData` | `python3 tools/scan_class_contracts/cli.py` |
