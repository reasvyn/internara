...
| ID    | Requirement |
| ----- | ----------- |
| FR-L1 | `BaseRecordManager` — table CRUD: search, filter, sort, pagination, selection, bulk actions, and **Extra Menu** (download template, import CSV/Excel, export CSV/Excel/PDF via `CsvHandler`) per project-requirements §6.2; import/export mechanics specified in [csv-import-export.md](O2KCR-csv-import-export.md) |
