...
See also: [daily-activity.md](1KSWL-daily-activity.md) — student daily operations (logbook, attendance,
absence requests).
...
|------|-----------------|
| [placement.md](J9GBH-placement.md) | Active placement records — supervision is scoped to placements |
| [daily-activity.md](1KSWL-daily-activity.md) | Logbook entries and attendance records — supervisors review and comment on these |
...
|-------|------|------------|
| 1 | [incident.md](3RU9S-incident.md) | Incident reports reference placement and supervision context |
