...
| [event-system.md](NUCY3-event-system.md) (NUCY3) | `BaseEvent` contract for job-dispatched events |
...
|-------|------|------------|
| 1 | [backup-system.md](HBXCI-backup-system.md) (HBXCI) | `SystemBackupCommand` and `CreateBackupAction` use queues for async backup operations |
| 2 | [system-maintenance.md](E1MSJ-system-maintenance.md) (E1MSJ) | `ArchiveStudentAccountsJob` and cleanup tasks dispatch via queue |
| 3 | [notification-infrastructure.md](TXR2H-notification-infrastructure.md) (TXR2H) | `SendNotificationAction` and `ShouldQueue` notifications dispatch via queue |
...
- `app/{Module}/Jobs/` — Queued jobs colocated with their owning module:
  - `app/Modules/Document/Jobs/GenerateDocumentJob.php`
  - `app/Modules/User/Jobs/ArchiveStudentAccountsJob.php`
  - `app/Modules/Certification/Jobs/BatchIssueCertificatesJob.php`
