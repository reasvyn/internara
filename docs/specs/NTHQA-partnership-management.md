...
capacity tracking, and CSV import/export are defined in [company-management.md](XI3LB-company-management.md).
...
| ID   | Non-Goal |
| ---- | -------- |
| NG1  | Company profile management (covered in [company-management.md](XI3LB-company-management.md) §Company CRUD) |
...
|------|-----------------|
| [company-management.md](XI3LB-company-management.md) | Company entities — partnerships are formalized relationships with these companies |
...
|-------|------|------------|
| 1 | [internship-lifecycle.md](7C5WM-internship-lifecycle.md) | Internship programs are scoped to partnerships; program phases reference partnership date ranges |
