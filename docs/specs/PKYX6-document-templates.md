...
See also: [handbooks.md](ZUFG8-handbooks.md) — handbook CRUD, audience targeting, student acknowledgment
...
### UC-PKYX6-1 — Admin Manages Document Templates
...
### UC-PKYX6-2 — Admin Generates a Report
...
|------|-----------------|
| [installation.md](8NZAU-installation.md) | System provisioned with default template configurations |
...
|-------|------|------------|
| 1 | [handbooks.md](ZUFG8-handbooks.md) | Handbooks use the document template engine for rendering and acknowledgement tracking |
| 2 | [certification.md](J0M04-certification.md) | Certificate generation uses templates from this spec |
