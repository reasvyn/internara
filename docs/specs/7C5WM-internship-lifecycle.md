...
initiative — see [internship-groups.md](IT0OE-internship-groups.md).
...
| ID   | Non-Goal                                                         |
| ---- | ---------------------------------------------------------------- |
| NG1  | Group management (see [internship-groups.md](IT0OE-internship-groups.md)) |
...
|-------|------|------------|
| 1 | [internship-groups.md](IT0OE-internship-groups.md) | Groups belong to programs; group members reference program phases for scheduling |
