...
|------|-----------------|
| [placement.md](J9GBH-placement.md) | Active placement records — evaluation gathers feedback within a placement context |
...
|-------|------|------------|
| 1 | [assignment.md](T657Z-assignment.md) | Assignment submissions are evaluated alongside this feedback |
| 2 | [certification.md](J0M04-certification.md) | Certification combines evaluation feedback with assessment scores |
