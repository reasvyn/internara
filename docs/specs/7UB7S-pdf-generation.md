...
|------|-----------------|
| [file-uploads-media.md](WQGTP-file-uploads-media.md) | Media storage for rendered PDF files |
...
|-------|------|------------|
| 1 | [reports.md](R6BMW-reports.md) | Reports generate grade card snapshots using PDF generation infrastructure |
