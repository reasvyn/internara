...
initiatives — see [registration.md](MBB5R-registration.md) and [placement.md](J9GBH-placement.md).
...
| NG2  | Placement management (see [placement.md](J9GBH-placement.md)) |
...
|------|-----------------|
| [registration.md](MBB5R-registration.md) | Registration workflow — account application is the self-service entry point |
