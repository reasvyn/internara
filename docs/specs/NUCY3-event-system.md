...
|------|-----------------|
| [base-classes.md](SE5Q9-base-classes.md) (SE5Q9) | `BaseEvent` class, `dispatchEvent()` method on `BaseAction` |
| [logging-and-error-handling.md](89SRA-logging-and-error-handling.md) | `SmartLogger` for event dispatch logging |
...
|-------|------|------------|
| 1 | [rbac-and-authorization.md](T4B26-rbac-and-authorization.md) | Authorization events dispatched via `BaseEvent`, audit logged via `SmartLogger` |
