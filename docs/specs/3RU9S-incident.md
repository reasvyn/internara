...
|------|-----------------|
| [placement.md](J9GBH-placement.md) | Active placement records — incidents are tied to specific placements |
...
|-------|------|------------|
| 1 | [assessment.md](ARDA6-assessment.md) | Assessment evaluates student competency; incidents may affect assessment context |
