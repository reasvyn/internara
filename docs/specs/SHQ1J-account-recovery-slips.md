...
| ID   | Non-Goal |
| ---- | -------- |
| NG1  | Super admin CLI recovery — see `recovery-ecosystem.md` (C9ZB6) |
| NG2  | Email-based password reset — see `password-reset.md` (D9TKW) |
...
|------|-----------------|
| [base-classes.md](SE5Q9-base-classes.md) (SE5Q9) | `BaseCommandAction`, `ActionResponse`, `RejectedException`, `BaseEntity`, `BaseData` |
| [authentication.md](YB7RG-authentication.md) (YB7RG) | `User` model, `AccessToken` model, auth infrastructure |
| [file-uploads-media.md](WQGTP-file-uploads-media.md) (WQGTP) | DomPDF for PDF generation |
