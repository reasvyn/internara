...
|------|------------------|
| [rbac-and-authorization.md](T4B26-rbac-and-authorization.md) (T4B26) | Roles (`superadmin`, `admin`, `teacher`, `student`, `supervisor`) used by `assignRole` |
| [department-management.md](4HWSB-department-management.md) (4HWSB), [academic-year-management.md](XW6F5-academic-year-management.md) (XW6F5) | `DepartmentFactory`, `AcademicYearFactory` and the active-year state |
| [company-management.md](XI3LB-company-management.md) (XI3LB), [partnership-management.md](NTHQA-partnership-management.md) (NTHQA) | `CompanyFactory`, `PartnershipFactory` with status states |
| [internship-lifecycle.md](7C5WM-internship-lifecycle.md) (7C5WM), [internship-groups.md](IT0OE-internship-groups.md) (IT0OE) | `InternshipFactory`, `InternshipGroupFactory`, `phases`/`grading_weights` contract |
| [registration.md](MBB5R-registration.md) (MBB5R), [placement.md](J9GBH-placement.md) (J9GBH) | `RegistrationFactory`, `PlacementFactory`, the `filled_quota` invariant, status lifecycle |
| [daily-activity.md](1KSWL-daily-activity.md) (1KSWL), [supervision.md](2EHSE-supervision.md) (2EHSE), [incident.md](3RU9S-incident.md) (3RU9S) | Logbook/Attendance/Absence/Supervision/Visit/Incident factories and status enums |
| [assessment.md](ARDA6-assessment.md) (ARDA6), [evaluation.md](AXKZW-evaluation.md) (AXKZW), [assignment.md](T657Z-assignment.md) (T657Z) | Rubric/Assessment/Evaluation/Assignment/Submission factories and `assessment_type` contract |
| [certification.md](J0M04-certification.md) (J0M04), [reports.md](R6BMW-reports.md) (R6BMW) | Certificate/Report factories, `grading_weights`, grade letter thresholds |
