...
See also: [supervision.md](2EHSE-supervision.md) — teacher/supervisor oversight features (supervision logs,
...
|------|-----------------|
| [placement.md](J9GBH-placement.md) | Active placement records — logbook and attendance are scoped to placements |
...
|-------|------|------------|
| 1 | [supervision.md](2EHSE-supervision.md) | Supervisors review logbook entries from this spec; monitoring visits reference attendance data |
