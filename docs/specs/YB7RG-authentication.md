...
|------|-----------------|
| [base-classes.md](SE5Q9-base-classes.md) (SE5Q9) | `BaseAuthenticatable`, `PasswordRules`, exception hierarchy |
| [rbac-and-authorization.md](T4B26-rbac-and-authorization.md) | Role assignment on login, `BasePolicy` auto-allow for super_admin |
...
|-------|------|------------|
| 1 | [school-profile.md](81SMS-school-profile.md) | Authenticated admin creates school profile; profile data used in documents and certificates |
