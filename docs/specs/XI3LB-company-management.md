...
| ID   | Non-Goal |
| ---- | -------- |
| NG1  | Partnership (MoU) lifecycle management — covered in [partnership-management.md](NTHQA-partnership-management.md) |
...
| NG5  | MoU document uploads, conversions, or versioning — covered in [partnership-management.md](NTHQA-partnership-management.md) |
| NG6  | Partnership status transitions, termination, or renewal — covered in [partnership-management.md](NTHQA-partnership-management.md) |
...
|------|-----------------|
| [school-profile.md](81SMS-school-profile.md) | School entity — companies partner with this school |
| [department-management.md](4HWSB-department-management.md) | Department entities — companies offer internships to specific departments |
