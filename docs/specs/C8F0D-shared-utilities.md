...
| ID   | Non-Goal |
| ---- | -------- |
| NG1  | SmartLogger, PiiMasker — see [logging-and-error-handling.md](89SRA-logging-and-error-handling.md) |
| NG2  | CsvHandler — see [csv-import-export.md](O2KCR-csv-import-export.md) |
| NG3  | ModuleService/ModuleManager — see [module-discovery.md](I1BCV-module-discovery.md) and [module-manager.md](B114U-module-manager.md) |
| NG4  | Base classes (Action, Entity, DTO, Model) — see [base-classes.md](SE5Q9-base-classes.md) |
...
| Utility | Full Spec |
| ------- | --------- |
| SmartLogger, PiiMasker | [logging-and-error-handling.md](89SRA-logging-and-error-handling.md) |
| CsvHandler | [csv-import-export.md](O2KCR-csv-import-export.md) |
...
|------|-----------------|
| [tech-stack.md](FB792-tech-stack.md) | PHP 8.4, Laravel framework classes (Translator, Cache, Facades) |
| [base-classes.md](SE5Q9-base-classes.md) | `BaseData`, `BaseEntity` contracts, `LabelEnum` interface |
