...
See also: [document-templates.md](PKYX6-document-templates.md) — document template management,
...
### UC-ZUFG8-1 — Admin Manages Handbooks
...
### UC-ZUFG8-2 — Student Views and Acknowledges Handbooks
...
### UC-ZUFG8-3 — Admin Renders Document for a Registration
...
> **Note:** The `documents` table schema is defined in [document-templates.md](PKYX6-document-templates.md).
...
|------|-----------------|
| [document-templates.md](PKYX6-document-templates.md) | Document template engine — handbooks use the same rendering infrastructure |
...
|-------|------|------------|
| 1 | [certification.md](J0M04-certification.md) | Certification generates certificates; handbook acknowledgement is a prerequisite for certificate issuance |
