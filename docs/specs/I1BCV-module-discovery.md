...
> [module-manager.md](B114U-module-manager.md) (B114U) — `Services/ModuleService` replaces
...
The discovery implementation API lives in [module-manager.md](B114U-module-manager.md) (B114U) §6.2:
...
|-------|------|------------|
| 1 | [logging-and-error-handling.md](89SRA-logging-and-error-handling.md) | Discovered Livewire components use `SmartLogger` and exception hierarchy |
