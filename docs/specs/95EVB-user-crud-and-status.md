...
| NG3  | CSV import/export (covered in [csv-import-export.md](O2KCR-csv-import-export.md)) |
| NG4  | Account slip PDF generation (covered in [account-slips.md](EWCZ0-account-slips.md)) |
...
|------|-----------------|
| [authentication.md](YB7RG-authentication.md) | Auth state, role-based access — user CRUD requires admin authentication |
...
|-------|------|------------|
| 1 | [csv-import-export.md](O2KCR-csv-import-export.md) | Bulk user import/export via CSV; uses `CsvHandler` from shared-utilities |
| 2 | [account-slips.md](EWCZ0-account-slips.md) | Generates credential documents for placed students from user data |
