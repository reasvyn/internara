...
covered in [authentication.md](YB7RG-authentication.md).
...
|------|-----------------|
| [authentication.md](YB7RG-authentication.md) | Authenticated user with role; session state for dashboard personalization |
...
|-------|------|------------|
| 1 | [department-management.md](4HWSB-department-management.md) | Admin dashboard shows department count; department data feeds program statistics |
| 2 | [academic-year-management.md](XW6F5-academic-year-management.md) | Dashboard shows active academic year; year status affects all module visibility |
