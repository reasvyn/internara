...
|------|-----------------|
| [school-profile.md](81SMS-school-profile.md) | School entity — academic years are scoped to this school |
| [settings-infrastructure.md](YB22J-settings-infrastructure.md) | Settings store for active year configuration |
...
|-------|------|------------|
| 1 | [company-management.md](XI3LB-company-management.md) | Companies offer internships within academic year date ranges; partnership dates reference academic years |
