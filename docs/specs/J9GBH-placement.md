...
initiatives — see [registration.md](MBB5R-registration.md) and [account-application.md](920SO-account-application.md).
...
| ID   | Non-Goal                                                         |
| ---- | ---------------------------------------------------------------- |
| NG1  | Registration workflow (see [registration.md](MBB5R-registration.md))   |
...
|------|-----------------|
| [registration.md](MBB5R-registration.md) | Enrollment records — placement matches these to companies |
| [partnership-management.md](NTHQA-partnership-management.md) | Partnership entities — placement assigns students to company partnerships |
...
|-------|------|------------|
| 1 | [daily-activity.md](1KSWL-daily-activity.md) | Reads active placement records for logbook and attendance tracking |
