...
**Detection:** `python3 scripts/scan_violations.py` · `python3 scripts/scan_conventions.py`.
...
**Detection:** `python3 scripts/scan_violations.py` (regex for `app()->make|app\(|resolve\()`).
...
**Detection:** `python3 scripts/scan_violations.py` · `scan_security.py` (SQLi).
...
**Detection:** `python3 scripts/scan_violations.py` · `scan_class_contracts.py` (Entity contract).
...
**Detection:** `python3 scripts/scan_violations.py` · `scan_class_contracts.py` (Data contract).
...
**Detection:** `python3 scripts/scan_violations.py` (parametric signature check).
...
**Detection:** `python3 scripts/scan_violations.py` · `scan_conventions.py`.
...
**Detection:** `python3 scripts/scan_conventions.py` (strict_types check).
...
**Detection:** `python3 scripts/scan_conventions.py` (debug call regex) · `rg "dd\\(|dump\\(|ray\\("`.
...
**Detection:** `python3 scripts/scan_conventions.py` · `scan_naming.py` (hardcoded strings).
...
**Detection:** `python3 scripts/scan_conventions.py` (Fillable attribute check).
...
**Detection:** `python3 scripts/scan_violations.py` · `scan_security.py` (mass assignment).
...
**Detection:** `python3 scripts/scan_violations.py` · `scan_security.py` (DB conventions).