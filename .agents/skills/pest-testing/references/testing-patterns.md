...
> **Changes:** extracted from SKILL.md — assertion patterns, examples, and quick-reference tables for all test types

Pattern reference for Livewire, Console, Events, Notifications, Mail, Queue, Permissions, Exceptions, Database, HTTP, State/Sequence, Mocking, Data Providers, Architecture, Coverage, and Common Mistakes.
