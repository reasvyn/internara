...
```bash
python3 scripts/scan_violations.py            # full invariant+security+performance scan
python3 scripts/scan_class_contracts.py       # class contract compliance
python3 scripts/scan_security.py              # S1-S10
python3 scripts/scan_naming.py                # naming
python3 scripts/scan_conventions.py           # conventions
python3 scripts/scan_doc_links.py             # doc links
...
`scripts/outputs/{timestamp}-{description}.json`.