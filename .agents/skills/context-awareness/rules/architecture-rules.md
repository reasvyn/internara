...
> **Last updated:** 2026-07-03 **Changes:** initial — verification checklist, not doc replacement

Do NOT use this as an authoritative spec. Read `docs/architecture.md` for the full architecture and
`app/Core/Actions/` files for actual contracts. This file lists what to check when verifying your
work.
