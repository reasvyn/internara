...
- Live in `resources/views/{domain}/{aggregate}/{component-name}.blade.php` for aggregate-specific views, or `resources/views/{domain}/{component-name}.blade.php` for cross-submodule views
