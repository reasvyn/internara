...
the refactor; verify with `python3 scripts/scan_conventions.py`.
...
`python3 scripts/scan_dead_code.py` to catch unregistered observers / orphan events / unused DTOs.
