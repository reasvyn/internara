...
permission:
  bash:
    "*": ask
    "git *": allow
    "python3 tools/scan_doc_links/cli.py": allow
    "python3 tools/scan_violations/cli.py": allow
...
3. **Automation-first**: `python3 tools/scan_doc_links/cli.py` for broken links + `OUTDATED_DOC` (>14 days) freshness; reuse scanners over manual greps.
