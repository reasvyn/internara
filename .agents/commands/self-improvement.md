...
2. **Write** to `context/` (mandatory fact) or `memory/` (evolving learning) — new file or update in place, write a descriptive commit message,
   then add/refresh the row in `context/index.md` or `memory/index.md`.
